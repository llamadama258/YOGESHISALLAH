...
function App() {
  ...
  useEffect(() => {
    if (screen === "loading") {
      setLoadingMsg(0);
      const i = setInterval(() => setLoadingMsg(m => (m + 1) % loadingMsgs.length), 1800);
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <nav style={{ ...S.nav }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <Gavel size={20} />
            <span style={{ fontWeight: 800, fontSize: 17, letterSpacing: "-0.03em", color: "#ffffff", fontFamily: "var(--font-heading)" }}>Sue the System</span>
          </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 24px 60px", textAlign: "center", position: "relative" }}>
          ...
          <div style={{ position: "absolute", top: "10%", left: "15%", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(12,123,95,0.08) 0%, transparent 70%)", filter: "blur(60px)", pointerEvents: "none", animation: "float 6s ease-in-out infinite" }} />
          <div style={{ position: "absolute", bottom: "20%", right: "10%", width: 250, height: 250, borderRadius: "50%", background: "radial-gradient(circle, rgba(37,99,235,0.06) 0%, transparent 70%)", filter: "blur(50px)", pointerEvents: "none", animation: "float 8s ease-in-out infinite 1s" }} />

          <div style={{ ...S.badge, position: "relative" }}>⚡ AI-Powered Legal Engine</div>
          <h1 style={{ fontSize: "clamp(48px, 9vw, 88px)", fontWeight: 900, margin: "0 0 24px", lineHeight: 0.95, letterSpacing: "-0.02em", color: "#1a1a2e", fontFamily: "var(--font-heading)" }}>
            They have lawyers.<br />
            <span style={{ background: "linear-gradient(135deg, #0C7B5F, #15967A)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Now you do too.</span>
          </h1>
          <p style={{ maxWidth: 560, fontSize: 18, color: "var(--dim)", lineHeight: 1.7, marginBottom: 48 }}>
            Describe your situation. Get a demand letter, regulatory complaint, email sequence, and complete legal strategy — powered by AI. <strong style={{ color: "#0C7B5F" }}>100% free.</strong>
          </p>
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
            <button onClick={() => { setStep(1); setScreen("intake"); }} style={{ ...S.btn, fontSize: 16, padding: "18px 48px", borderRadius: 12, boxShadow: "0 8px 32px rgba(12,123,95,0.3)" }}>
              ⚖️ Build My Case →
            </button>
            <button onClick={() => setScreen("scanner")} style={{ ...S.ghostBtn, fontSize: 16, padding: "18px 32px", borderRadius: 12, background: "rgba(239,68,68,0.06)", borderColor: "rgba(239,68,68,0.2)", color: "#dc2626" }}>
              🔍 Scam Scanner
            </button>
            {cases.length > 0 && (
          ...
          <div style={{ display: "flex", gap: 48, marginTop: 72, flexWrap: "wrap", justifyContent: "center" }}>
            {[["8", "Categories"], ["5+", "Documents"], ["50", "US States"], ["$0", "Cost"]].map(([n, l]) => (
              <div key={l} style={{ textAlign: "center", animation: "fadeUp 0.5s ease" }}>
                <div style={{ fontSize: 36, fontWeight: 900, background: "linear-gradient(135deg, #0C7B5F, #15967A)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", lineHeight: 1 }}>{n}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12, maxWidth: 860, width: "100%", marginTop: 72 }}>
            {CATEGORIES.map((c, idx) => (
              <button key={c.id} onClick={() => { setForm(f => ({ ...f, category: c.id })); setStep(1); setScreen("intake"); }}
                style={{ ...S.glassCard, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "18px", border: "1px solid rgba(0,0,0,0.08)", animation: `fadeUp 0.4s ease ${idx * 0.05}s both`, position: "relative", overflow: "hidden" }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 700, marginBottom: 4, color: "#1a1a2e" }}>{c.label}</span>
        ...
        <footer style={{ textAlign: "center", padding: "24px", fontSize: 11, color: "#9ca3af", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px", animation: "fadeUp 0.4s ease" }}>
            ...
            {[1, 2, 3, 4].map(i => (
              <React.Fragment key={i}>
                <div style={{
                  ...
                  background: i < step ? "linear-gradient(135deg, #0C7B5F, #15967A)" : i === step ? "linear-gradient(135deg, #0C7B5F, #2563eb)" : "#e5e7eb",
                  border: `2px solid ${i <= step ? "transparent" : "#d1d5db"}`,
                  fontSize: 13, fontWeight: 700, color: i <= step ? "#fff" : "var(--dim)",
                  boxShadow: i === step ? "0 0 16px rgba(12,123,95,0.3)" : "none",
                  transition: "all 0.3s ease"
                }}>
                  {i < step ? "✓" : i}
                </div>
                {i < 4 && <div style={{ width: 32, height: 2, borderRadius: 1, background: i < step ? "linear-gradient(90deg, #0C7B5F, #15967A)" : "#d1d5db", transition: "all 0.3s" }} />}
              </React.Fragment>
            ))}
          </div>
              ...
              {CATEGORIES.map(c => (
                <button key={c.id} onClick={() => setForm(f => ({ ...f, category: c.id }))}
                  style={{
                    ...
                    borderColor: form.category === c.id ? c.color : "rgba(0,0,0,0.08)",
                    background: form.category === c.id ? `linear-gradient(135deg, ${c.color}15, ${c.color}08)` : "#ffffff",
                    boxShadow: form.category === c.id ? `0 4px 16px ${c.color}20` : "0 1px 3px rgba(0,0,0,0.06)",
                    position: "relative", overflow: "hidden"
                  }}>
                  {form.category === c.id && <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: c.color }} />}
                  <span style={{ fontSize: 28 }}>{c.icon}</span>
                  <div style={{ fontWeight: 700, fontSize: 14, marginTop: 10, color: form.category === c.id ? "#1a1a2e" : "#374151" }}>{c.label}</div>
        ...
        {step === 2 && (
          <div style={{ animation: "fadeUp 0.3s ease" }}>
            ...
            <p style={{ color: "var(--dim)", marginBottom: 24, lineHeight: 1.7, fontSize: 15 }}>Be specific. Include dates, dollar amounts, names of companies or people, and what they said or did. <strong style={{ color: "#0C7B5F" }}>The more detail, the stronger your case.</strong></p>
            {urgentDetected && (
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
              <span style={{ fontSize: 12, color: form.situation.length < 100 ? "#dc2626" : "#0C7B5F", fontWeight: 600 }}>
        ...
        {step === 3 && (
          <div style={{ animation: "fadeUp 0.3s ease" }}>
            ...
            <p style={{ color: "var(--dim)", marginBottom: 24, lineHeight: 1.7, fontSize: 15 }}>List any documents, photos, emails, receipts, or records. <strong style={{ color: "#0C7B5F" }}>Don't worry if you don't have much</strong> — we'll tell you what to gather.</p>
            <textarea
              value={form.evidence}
        ...
        {step === 4 && (
          <div style={{ animation: "fadeUp 0.3s ease" }}>
              ...
              {["Full refund / payment", "Claim approved", "Repairs completed", "Reinstatement", "Written apology", "Policy change"].map(o => (
                <button key={o} onClick={() => setForm(f => ({ ...f, outcome: o }))}
                  style={{
                    ...
                    borderColor: form.outcome === o ? "#0C7B5F" : "rgba(0,0,0,0.08)",
                    background: form.outcome === o ? "linear-gradient(135deg, rgba(12,123,95,0.12), rgba(12,123,95,0.06))" : "#ffffff",
                    boxShadow: form.outcome === o ? "0 4px 16px rgba(12,123,95,0.15)" : "0 1px 3px rgba(0,0,0,0.06)",
                    color: form.outcome === o ? "#0C7B5F" : "#374151"
                  }}>
                  {o}
                </button>
              ))}
            ...
            />
            <button onClick={buildCase} disabled={!form.outcome.trim()} style={{ ...S.btn, width: "100%", marginTop: 28, fontSize: 16, padding: "18px", borderRadius: 12, boxShadow: "0 8px 32px rgba(12,123,95,0.25)" }}>
              ⚖️ Build My Case →
            </button>
          </div>
        )}
  ...
  if (screen === "loading") return (
    <Shell>
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, position: "relative" }}>
        {/* Background glow */}
        <div style={{ position: "absolute", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(12,123,95,0.06) 0%, transparent 70%)", filter: "blur(80px)", animation: "pulse 3s ease-in-out infinite" }} />

        <div style={{ textAlign: "center", animation: "fadeUp 0.3s ease", position: "relative" }}>
          {/* Swinging justice scale */}
          <div style={{ position: "relative", width: 160, height: 160, margin: "0 auto", marginBottom: 12 }}>
            {/* Pivot point */}
            <div style={{
              position: "absolute", top: 8, left: "50%", transform: "translateX(-50%)",
              width: 12, height: 12, borderRadius: "50%",
              background: "linear-gradient(135deg, #0C7B5F, #15967A)",
              boxShadow: "0 0 16px rgba(12,123,95,0.4)",
              zIndex: 2
            }} />
            {/* Scale beam + pans */}
            <div style={{
              ...
              <div style={{
                ...
                background: "linear-gradient(90deg, #0C7B5F, #15967A, #0C7B5F)",
                boxShadow: "0 0 12px rgba(12,123,95,0.2)"
              }} />
              <div style={{ position: "absolute", top: 4, left: "-55px", width: 2, height: 36, background: "linear-gradient(to bottom, #0C7B5F, #086B52)", borderRadius: 1 }} />
              <div style={{ position: "absolute", top: 4, left: "53px", width: 2, height: 36, background: "linear-gradient(to bottom, #0C7B5F, #086B52)", borderRadius: 1 }} />
              <div style={{
                position: "absolute", top: 40, left: "-72px",
                width: 36, height: 8, borderRadius: "0 0 50% 50%",
                background: "linear-gradient(135deg, #0C7B5F, #086B52)",
                boxShadow: "0 4px 12px rgba(12,123,95,0.2)"
              }} />
              <div style={{
            ...
            <div style={{
              ...
              background: "linear-gradient(to bottom, #0C7B5F, #065740)"
            }} />
            {/* Base */}
            <div style={{
              ...
              background: "linear-gradient(135deg, #0C7B5F, #15967A)",
              boxShadow: "0 4px 16px rgba(12,123,95,0.3)"
            }} />
            {/* Subtle glow */}
            <div style={{
              position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)",
              width: 120, height: 120, borderRadius: "50%",
              background: "radial-gradient(circle, rgba(12,123,95,0.08) 0%, transparent 70%)",
              animation: "pulse 2s ease-in-out infinite"
            }} />
          </div>

          <p style={{
            fontSize: 22, fontWeight: 700, marginBottom: 8, marginTop: 12,
            fontFamily: "var(--font-heading)",
            color: "#0C7B5F"
          }}>{loadingMsgs[loadingMsg]}</p>
          <p style={{ fontSize: 14, color: "var(--dim)", marginBottom: 40 }}>Building your complete case file...</p>

          {/* Progress bar */}
          <div style={{ width: 280, margin: "0 auto 32px" }}>
            <div style={{ height: 6, background: "#e5e7eb", borderRadius: 3, overflow: "hidden" }}>
              <div style={{
                height: "100%", borderRadius: 3,
                background: "linear-gradient(90deg, #0C7B5F, #15967A, #2563eb)",
                backgroundSize: "200% 100%",
                animation: "shimmer 1.5s linear infinite",
                width: `${Math.min(95, (loadingMsg + 1) / loadingMsgs.length * 100)}%`,
            ...
            {loadingMsgs.map((m, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, opacity: i <= loadingMsg ? 1 : 0.15, transition: "opacity 0.4s ease", animation: i === loadingMsg ? "fadeUp 0.3s ease" : "none" }}>
                <div style={{
                  ...
                  background: i < loadingMsg ? "linear-gradient(135deg, #0C7B5F, #15967A)" : i === loadingMsg ? "linear-gradient(135deg, #0C7B5F, #2563eb)" : "#e5e7eb",
                  color: i <= loadingMsg ? "#fff" : "var(--dim)",
                  boxShadow: i === loadingMsg ? "0 0 12px rgba(12,123,95,0.3)" : "none",
                  transition: "all 0.4s ease"
                }}>
                  {i < loadingMsg ? "✓" : i === loadingMsg ? "•" : ""}
                </div>
                <span style={{ fontSize: 13, color: i <= loadingMsg ? "#374151" : "var(--dim)", fontWeight: i === loadingMsg ? 600 : 400, transition: "all 0.3s" }}>{m}</span>
              </div>
            ))}
          </div>
        </div>
    ...
    return (
      <Shell>
        ...
        <div style={{ animation: "fadeUp 0.4s ease" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) 340px", gap: 0, maxWidth: 1400, margin: "0 auto", width: "100%", padding: "0 16px" }}>

            {/* LEFT: Main content */}
            <div style={{ padding: "32px 24px", borderRight: "1px solid rgba(0,0,0,0.08)", minWidth: 0 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 28 }}>
                ...
                <div style={{ ...S.glassCard, textAlign: "center", padding: "20px 12px", position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ fontSize: 36, fontWeight: 900, color: scoreColor, lineHeight: 1 }}>{results.strengthScore}%</div>
                ...
                <div style={{ ...S.glassCard, textAlign: "center", padding: "20px 12px", position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ fontSize: 36, fontWeight: 900, color: "#10b981", lineHeight: 1 }}>{results.winProbability?.settlement || "—"}%</div>
                ...
                {/* Full Win */}
                <div style={{ ...S.glassCard, textAlign: "center", padding: "20px 12px", position: "relative", overflow: "hidden" }}>
                  <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: "linear-gradient(90deg, #0C7B5F, #15967A)" }} />
                  <div style={{ fontSize: 36, fontWeight: 900, color: "#0C7B5F", lineHeight: 1 }}>{results.winProbability?.fullWin || "—"}%</div>
                ...
                <div style={{ ...S.glassCard, textAlign: "center", padding: "20px 12px", position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ fontSize: 28, fontWeight: 900, color: urgencyColor, lineHeight: 1, textTransform: "capitalize" }}>{results.urgencyLevel}</div>
              ...
              <div style={{ ...S.glassCard, marginBottom: 24, padding: "20px 24px" }}>
                <p style={{ margin: 0, color: "#374151", lineHeight: 1.7, fontSize: 15 }}>{results.summary}</p>
              ...
              {/* Tabs */}
              <div style={{ display: "flex", gap: 4, borderBottom: "1px solid rgba(0,0,0,0.1)", marginBottom: 28, overflowX: "auto", paddingBottom: 0 }}>
                {tabs.map(t => (
                  <button key={t.id} onClick={() => setActiveTab(t.id)}
                    style={{
                      background: activeTab === t.id ? "rgba(12,123,95,0.08)" : "none",
                      border: "none",
                      borderBottom: activeTab === t.id ? "2px solid #0C7B5F" : "2px solid transparent",
                      color: activeTab === t.id ? "#0C7B5F" : "var(--dim)",
                      padding: "12px 16px",
                      cursor: "pointer",
                      fontSize: 13,
                      fontFamily: "var(--font)",
                  ...
                  {results.nextSteps?.map((s, i) => (
                    <div key={i} style={{ ...S.glassCard, display: "flex", gap: 16, alignItems: "flex-start" }}>
                      <div style={{
                        ...
                        background: s.importance === "critical" ? "linear-gradient(135deg, #ef4444, #dc2626)" : s.importance === "important" ? "linear-gradient(135deg, #fbbf24, #f59e0b)" : "#e5e7eb",
                      ...
                      <div style={{
                        ...
                        background: s.importance === "critical" ? "rgba(239,68,68,0.08)" : s.importance === "important" ? "rgba(251,191,36,0.08)" : "#f3f4f6",
                        color: s.importance === "critical" ? "#dc2626" : s.importance === "important" ? "#b45309" : "var(--dim)",
                        border: `1px solid ${s.importance === "critical" ? "rgba(239,68,68,0.2)" : s.importance === "important" ? "rgba(251,191,36,0.2)" : "var(--border)"}`,
              ...
              {activeTab === "rights" && (
                <div style={{ display: "flex", flexDirection: "column", gap: 14, animation: "fadeUp 0.3s ease" }}>
                  ...
                  {results.rights?.map((r, i) => (
                    <div key={i} style={{ ...S.glassCard, borderLeft: `4px solid ${r.strength === "strong" ? "#0C7B5F" : r.strength === "moderate" ? "#f59e0b" : "#6b7280"}` }}>
                      <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", marginBottom: 8 }}>
                        <div style={{ fontWeight: 700, fontSize: 16 }}>{r.title}</div>
                        <div style={{ display: "flex", gap: 8 }}>
                          <span style={{ fontSize: 11, color: "#0C7B5F", background: "rgba(12,123,95,0.08)", padding: "4px 10px", borderRadius: 6, border: "1px solid rgba(12,123,95,0.2)", fontWeight: 600 }}>📜 {r.law}</span>
                          <span style={{
                            fontSize: 11, padding: "4px 10px", borderRadius: 6,
                            background: r.strength === "strong" ? "rgba(12,123,95,0.08)" : r.strength === "moderate" ? "rgba(245,158,11,0.08)" : "#f3f4f6",
                            border: `1px solid ${r.strength === "strong" ? "rgba(12,123,95,0.2)" : r.strength === "moderate" ? "rgba(245,158,11,0.2)" : "var(--border)"}`,
                            color: r.strength === "strong" ? "#0C7B5F" : r.strength === "moderate" ? "#b45309" : "var(--dim)",
                            textTransform: "capitalize", fontWeight: 700
                          }}>{r.strength}</span>
                        </div>
                      </div>
                      <p style={{ margin: 0, fontSize: 14, color: "#4b5563", lineHeight: 1.7 }}>{r.description}</p>
                    </div>
                  ))}
                </div>
              )}
                ...
                <div style={{ animation: "fadeUp 0.3s ease" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      {activeTab === "letter" && (
                        <button onClick={generateLetter} style={{ ...S.smallBtn, background: "rgba(12,123,95,0.1)" }}>🔄 Regenerate with AI</button>
                      )}
                    </div>
                  </div>
                  <div style={{ ...S.glassCard, fontFamily: "'Courier New', monospace", fontSize: 13, lineHeight: 1.9, whiteSpace: "pre-wrap", color: "#374151", position: "relative" }}>
              ...
              {activeTab === "emails" && (
                <div style={{ display: "flex", flexDirection: "column", gap: 20, animation: "fadeUp 0.3s ease" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <button onClick={generateEmails} style={{ ...S.smallBtn, background: "rgba(12,123,95,0.1)" }}>🔄 Regenerate with AI</button>
                  </div>
                  {results.emailSequence?.map((e, i) => (
                    <div key={i} style={{ ...S.glassCard, position: "relative", overflow: "hidden" }}>
                      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: i === 0 ? "linear-gradient(90deg, #0C7B5F, #15967A)" : i === 1 ? "linear-gradient(90deg, #f59e0b, #ef4444)" : "linear-gradient(90deg, #ef4444, #dc2626)" }} />
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14, flexWrap: "wrap", gap: 8 }}>
                        <div>
                          <div style={{ display: "flex", gap: 8, marginBottom: 6 }}>
                            <span style={{ fontSize: 11, color: "#0C7B5F", background: "rgba(12,123,95,0.08)", padding: "3px 10px", borderRadius: 20, fontWeight: 700, letterSpacing: "0.08em" }}>📅 {e.timing}</span>
                            <span style={{ fontSize: 11, color: "#b45309", background: "rgba(245,158,11,0.08)", padding: "3px 10px", borderRadius: 20, fontWeight: 700 }}>{e.tone}</span>
                          </div>
                      ...
                      <div style={{ background: "#f9fafb", borderRadius: 8, padding: "16px 20px", border: "1px solid rgba(0,0,0,0.06)" }}>
                        <pre style={{ margin: 0, fontSize: 13, lineHeight: 1.8, whiteSpace: "pre-wrap", color: "#374151", fontFamily: "inherit" }}>{e.body}</pre>
                      </div>
                    </div>
                  ))}
                </div>
                    ...
                    <div key={i} style={S.glassCard}>
                      <div style={{ display: "flex", gap: 10, marginBottom: 14 }}>
                        <span style={{
                          ...
                          background: r.probability === "likely" ? "rgba(239,68,68,0.08)" : r.probability === "possible" ? "rgba(245,158,11,0.08)" : "#f3f4f6",
                          border: `1px solid ${r.probability === "likely" ? "rgba(239,68,68,0.2)" : r.probability === "possible" ? "rgba(245,158,11,0.2)" : "var(--border)"}`,
                          color: r.probability === "likely" ? "#dc2626" : r.probability === "possible" ? "#b45309" : "var(--dim)",
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                        <div style={{ background: "rgba(239,68,68,0.06)", borderRadius: 8, padding: 16, border: "1px solid rgba(239,68,68,0.15)" }}>
                          ...
                          <p style={{ margin: 0, fontSize: 14, lineHeight: 1.7, color: "#4b5563", fontStyle: "italic" }}>"{r.response}"</p>
                        </div>
                      ...
                      <div style={{ ...S.glassCard, position: "relative", overflow: "hidden" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, marginBottom: 20 }}>
                          ...
                          <div style={{ textAlign: "center", position: "relative" }}>
                            ...
                            <div style={{ fontSize: 42, fontWeight: 900, color: "#10b981" }}>${(results.settlementEstimate.median || 0).toLocaleString()}</div>
                          </div>
                          <div style={{ textAlign: "center" }}>
                            ...
                            <div style={{ fontSize: 32, fontWeight: 900, color: "#0C7B5F" }}>${(results.settlementEstimate.highRange || 0).toLocaleString()}</div>
                          </div>
                        </div>
                        {/* Range bar */}
                        <div style={{ position: "relative", height: 12, background: "#e5e7eb", borderRadius: 6, overflow: "hidden", marginBottom: 16 }}>
                          <div style={{ position: "absolute", top: 0, left: "10%", right: "10%", bottom: 0, background: "linear-gradient(90deg, #fbbf24, #10b981, #0C7B5F)", borderRadius: 6, opacity: 0.7 }} />
                        ...
                        <p style={{ margin: 0, fontSize: 14, color: "#4b5563", lineHeight: 1.7, fontStyle: "italic" }}>📊 {results.settlementEstimate.basis}</p>
                      </div>
                      {results.settlementEstimate.factors?.length > 0 && (
                        <div style={S.glassCard}>
                          ...
                          {results.settlementEstimate.factors.map((f, i) => (
                            <div key={i} style={{ display: "flex", gap: 10, alignItems: "center", padding: "10px 0", borderBottom: i < results.settlementEstimate.factors.length - 1 ? "1px solid rgba(0,0,0,0.06)" : "none" }}>
                              <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#0C7B5F", flexShrink: 0 }} />
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14, animation: "fadeUp 0.3s ease" }}>
                  ...
                  {results.filingAgencies?.map((a, i) => (
                    <div key={i} style={S.glassCard}>
                      ...
                      <a href={a.url} target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: "#0C7B5F", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6, fontWeight: 600 }}>
                        🔗 {a.url} →
                      </a>
                    </div>
                  ))}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12, animation: "fadeUp 0.3s ease" }}>
                  ...
                  {results.evidenceChecklist?.map((e, i) => (
                    <div key={i} style={{ ...S.glassCard, display: "flex", gap: 14, alignItems: "flex-start" }}>
                      ...
                      <span style={{
                        fontSize: 11, padding: "4px 10px", borderRadius: 6,
                        background: e.priority === "essential" ? "rgba(239,68,68,0.06)" : e.priority === "helpful" ? "rgba(245,158,11,0.06)" : "#f3f4f6",
                        border: `1px solid ${e.priority === "essential" ? "rgba(239,68,68,0.15)" : e.priority === "helpful" ? "rgba(245,158,11,0.15)" : "var(--border)"}`,
                        color: e.priority === "essential" ? "#dc2626" : e.priority === "helpful" ? "#b45309" : "var(--dim)",
                    ...
                    {chatMessages.map((m, i) => (
                      <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start", animation: "fadeUp 0.2s ease" }}>
                        <div style={{
                          ...
                          background: m.role === "user" ? "linear-gradient(135deg, #0C7B5F, #15967A)" : "#f8f9fa",
                          border: m.role === "assistant" ? "1px solid rgba(0,0,0,0.1)" : "none",
                          fontSize: 14, lineHeight: 1.7, color: m.role === "user" ? "#ffffff" : "#1a1a2e",
                          borderBottomRightRadius: m.role === "user" ? 4 : 16,
                          borderBottomLeftRadius: m.role === "assistant" ? 4 : 16,
                          whiteSpace: "pre-wrap",
                          boxShadow: m.role === "user" ? "0 4px 12px rgba(12,123,95,0.25)" : "0 1px 3px rgba(0,0,0,0.06)",
                        }}>{m.content}</div>
                      </div>
                    ))}
                    {chatLoading && (
            ...
            <div style={{ padding: "32px 24px", position: "sticky", top: 80, height: "calc(100vh - 80px)", overflowY: "auto" }}>
              ...
              <div style={{ ...S.glassCard, marginBottom: 16, padding: "20px", position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: "linear-gradient(90deg, #0C7B5F, #15967A, #06b6d4)" }} />
                ...
                {results.rights?.length > 0 ? results.rights.map((r, i) => (
                  <div key={i} style={{ padding: "12px 0", borderBottom: i < results.rights.length - 1 ? "1px solid rgba(0,0,0,0.08)" : "none" }}>
                    <div style={{ fontSize: 12, color: "#0C7B5F", fontWeight: 700, marginBottom: 4, letterSpacing: "0.02em" }}>{r.law}</div>
                    ...
                    <div style={{
                      ...
                      background: r.strength === "strong" ? "rgba(16,185,129,0.15)" : r.strength === "moderate" ? "rgba(251,191,36,0.15)" : "rgba(0,0,0,0.04)",
              ...
              <div style={{ ...S.glassCard, textAlign: "center", padding: "24px 20px", marginBottom: 16, position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ marginTop: -80, marginBottom: 36, fontSize: 28, fontWeight: 900, color: scoreColor }}>{results.strengthScore}%</div>
              ...
              {results.filingAgencies?.length > 0 && (
                <div style={{ ...S.glassCard, padding: "20px", position: "relative", overflow: "hidden" }}>
                  ...
                  {results.filingAgencies.map((a, i) => (
                    <div key={i} style={{ padding: "8px 0", borderBottom: i < results.filingAgencies.length - 1 ? "1px solid rgba(0,0,0,0.08)" : "none" }}>
            ...
            {cases.map((c, idx) => {
              ...
              return (
                <button key={c.id} onClick={() => openCase(c)}
                  ...
                  <div style={{ width: 48, height: 48, borderRadius: 12, background: `${cat?.color || "#0C7B5F"}20`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, flexShrink: 0 }}>
                    {cat?.icon || "⚖️"}
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 11, color: "#6b7280", marginTop: 6 }}>{new Date(c.createdAt).toLocaleDateString(undefined, { month: "short", day: "numeric", year: "numeric" })}</div>
                  </div>
        ...
        {!contractResult ? (
          <div style={{ ...S.glassCard, padding: 32 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10, marginBottom: 20 }}>
              <span style={{ fontSize: 12, color: contractText.length < 100 ? "#dc2626" : "#10b981", fontWeight: 600 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ ...S.glassCard, textAlign: "center", padding: "32px 24px", position: "relative", overflow: "hidden" }}>
              ...
              <p style={{ margin: 0, fontSize: 15, color: "#6b7280", lineHeight: 1.7, maxWidth: 600, marginLeft: "auto", marginRight: "auto" }}>{contractResult.summary}</p>
            </div>
                    ...
                    <div key={i} style={{ ...S.glassCard, borderLeft: `4px solid ${flag.severity === "critical" ? "#ef4444" : flag.severity === "warning" ? "#fbbf24" : "#3b82f6"}` }}>
                      <div style={{ display: "flex", justifyContent: "space-between", gap: 8, marginBottom: 10, flexWrap: "wrap" }}>
                        <span style={{
                          ...
                          color: flag.severity === "critical" ? "#dc2626" : flag.severity === "warning" ? "#b45309" : "#2563eb",
                          border: `1px solid ${flag.severity === "critical" ? "rgba(239,68,68,0.3)" : flag.severity === "warning" ? "rgba(251,191,36,0.3)" : "rgba(59,130,246,0.3)"}`
                        }}>{flag.severity}</span>
                        {flag.law && <span style={{ fontSize: 11, color: "#0C7B5F", background: "rgba(12,123,95,0.1)", padding: "4px 10px", borderRadius: 20, fontWeight: 600 }}>📜 {flag.law}</span>}
                      </div>
                      <div style={{ background: "rgba(239,68,68,0.06)", borderRadius: 8, padding: 14, marginBottom: 12, border: "1px solid rgba(239,68,68,0.15)" }}>
                        <p style={{ margin: 0, fontSize: 14, color: "#dc2626", lineHeight: 1.6, fontStyle: "italic" }}>"{flag.clause}"</p>
                      </div>
                      <p style={{ margin: "0 0 8px", fontSize: 14, color: "#374151", lineHeight: 1.6 }}><strong>Issue:</strong> {flag.issue}</p>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {contractResult.greenFlags.map((g, i) => (
                    <div key={i} style={{ ...S.glassCard, borderLeft: "4px solid #10b981" }}>
                      <p style={{ margin: "0 0 6px", fontSize: 14, color: "#059669", fontStyle: "italic" }}>"{g.clause}"</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              {contractResult.missingProtections?.length > 0 && (
                <div style={S.glassCard}>
                  ...
                  {contractResult.missingProtections.map((m, i) => (
                    <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start", padding: "8px 0", borderBottom: i < contractResult.missingProtections.length - 1 ? "1px solid rgba(0,0,0,0.06)" : "none" }}>
              ...
              {contractResult.negotiationTips?.length > 0 && (
                <div style={S.glassCard}>
                  <h4 style={{ fontSize: 15, fontWeight: 700, marginBottom: 14, color: "#0C7B5F" }}>💬 Negotiation Tips</h4>
                  {contractResult.negotiationTips.map((t, i) => (
                    <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start", padding: "8px 0", borderBottom: i < contractResult.negotiationTips.length - 1 ? "1px solid rgba(0,0,0,0.06)" : "none" }}>
                      <span style={{ color: "#0C7B5F", flexShrink: 0 }}>{i + 1}.</span>
    ...
    <div style={{
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; }
        ...
        @keyframes glow { 0%,100%{box-shadow: 0 0 20px rgba(12,123,95,0.2)} 50%{box-shadow: 0 0 40px rgba(12,123,95,0.35)} }
        ...
        select { background-color: #ffffff !important; color: #1a1a2e !important; appearance: auto; }
        select option { background: #ffffff; color: #1a1a2e; padding: 8px; }
        select option:checked { background: #e6f5f1; color: #0C7B5F; }
        select option:hover { background: #e6f5f1; }
        input:focus, textarea:focus, select:focus { outline: none; border-color: #0C7B5F !important; box-shadow: 0 0 0 3px rgba(12,123,95,0.15), 0 0 20px rgba(12,123,95,0.08); }
        textarea::placeholder, input::placeholder { color: #9ca3af; }
        ::-webkit-scrollbar { width: 6px; height: 6px; }
        ::-webkit-scrollbar-track { background: #f0f2f5; }
        ::-webkit-scrollbar-thumb { background: rgba(12,123,95,0.35); border-radius: 3px; }
        ::-webkit-scrollbar-thumb:hover { background: rgba(12,123,95,0.55); }
        button { transition: all 0.2s cubic-bezier(0.4, 0, 0.2, 1); }
        button:hover { transform: translateY(-1px); }
        button:active { transform: translateY(0); }
        a { transition: color 0.2s; }
        a:hover { text-decoration: underline; }
        ::selection { background: rgba(12,123,95,0.2); }
      `}</style>
    </div>
  );
}
...
const S = {
  hero: { fontSize: "clamp(40px, 8vw, 80px)", fontWeight: 900, margin: "0 0 16px", lineHeight: 0.95, letterSpacing: "-0.03em", color: "#1a1a2e", textShadow: "none" },
  sub: { fontSize: 16, color: "var(--dim)", lineHeight: 1.7, margin: "0 auto" },
  badge: { display: "inline-block", background: "linear-gradient(135deg, rgba(12,123,95,0.12), rgba(12,123,95,0.06))", border: "1px solid rgba(12,123,95,0.3)", borderRadius: 20, padding: "6px 16px", fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", color: "#0C7B5F", marginBottom: 20, animation: "glow 3s ease-in-out infinite" },
  nav: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 24px", borderBottom: "1px solid rgba(0,0,0,0.08)", background: "#1B2A3F", backdropFilter: "blur(10px)" },
  navBtn: { background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.25)", borderRadius: 8, padding: "8px 16px", color: "#ffffff", fontSize: 12, cursor: "pointer", fontFamily: "inherit", fontWeight: 600 },
  backBtn: { background: "none", border: "none", color: "#ffffff", fontSize: 13, cursor: "pointer", fontFamily: "inherit", padding: "4px 0", fontWeight: 500 },
  card: { background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "20px", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" },
  btn: { background: "linear-gradient(135deg, #0C7B5F 0%, #15967A 100%)", border: "none", borderRadius: 8, color: "white", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", padding: "14px 24px", letterSpacing: "0.02em", boxShadow: "0 4px 12px rgba(12,123,95,0.3)" },
  ghostBtn: { background: "rgba(12,123,95,0.08)", border: "1px solid rgba(12,123,95,0.2)", borderRadius: 8, color: "#0C7B5F", fontSize: 13, cursor: "pointer", fontFamily: "inherit", padding: "12px 20px", fontWeight: 600 },
  smallBtn: { background: "rgba(12,123,95,0.08)", border: "1px solid rgba(12,123,95,0.2)", borderRadius: 6, color: "#0C7B5F", fontSize: 12, cursor: "pointer", fontFamily: "inherit", padding: "6px 12px", fontWeight: 600 },
  input: { width: "100%", background: "#ffffff", border: "1px solid rgba(0,0,0,0.15)", borderRadius: 8, padding: "14px 16px", color: "#1a1a2e", fontSize: 14, fontFamily: "inherit", transition: "all 0.2s" },
  ...
  catCard: { background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "14px", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "flex-start", transition: "all 0.3s", color: "var(--text)", fontFamily: "inherit" },
  optionBtn: { background: "#ffffff", border: "1px solid rgba(0,0,0,0.1)", borderRadius: 8, padding: "12px", cursor: "pointer", color: "var(--text)", fontFamily: "inherit", fontSize: 13, transition: "all 0.3s", textAlign: "center", fontWeight: 500 },
  stepTitle: { fontSize: 28, fontWeight: 900, margin: "0 0 12px", letterSpacing: "-0.02em", color: "#1a1a2e", fontFamily: "var(--font-heading)" },
  sectionTitle: { fontSize: 18, fontWeight: 700, margin: "0 0 16px", letterSpacing: "-0.01em", color: "#1a1a2e", fontFamily: "var(--font-heading)" },
  errorBox: { background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.3)", borderRadius: 8, padding: "12px 16px", marginBottom: 20, fontSize: 14, color: "#dc2626" },
  urgentBox: { background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.3)", borderRadius: 8, padding: "12px 16px", fontSize: 13, color: "#b45309", lineHeight: 1.5 },
  spinner: { width: 48, height: 48, border: "3px solid rgba(12,123,95,0.15)", borderTop: "3px solid #0C7B5F", borderRadius: "50%", margin: "0 auto", animation: "spin 0.8s linear infinite" },
  glassCard: { background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 14, padding: "20px", boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)", transition: "all 0.3s ease" },
  sidebarBtn: { width: "100%", background: "rgba(12,123,95,0.06)", border: "1px solid rgba(12,123,95,0.15)", borderRadius: 8, padding: "10px 14px", color: "#0C7B5F", fontSize: 13, cursor: "pointer", fontFamily: "inherit", fontWeight: 600, textAlign: "left", transition: "all 0.2s" },
};
